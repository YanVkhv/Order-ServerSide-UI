...
class CustomerApplicationServiceIntegrationTest extends IntegrationTest {
    ...
    @Test
    void createCustomer() {
        CustomerDto createdCustomer = customerApplicationService.createCustomer(createACustomer());
...
//                .postForObject(format(HTTP_LOCALHOST + ":%s/%s", getPort(), CustomerApplicationService.RESOURCE_NAME), customerToCreate, ControllerExceptionHandler.Error.class);
//
...
//                .exchange(format(HTTP_LOCALHOST + ":%s/%s/%s", getPort(), CustomerApplicationService.RESOURCE_NAME, alreadyExistingCustomer.getId().toString()),
//                        HttpMethod.PUT,
...
//                .postForObject(format(HTTP_LOCALHOST + ":%s/%s", getPort(), CustomerApplicationService.RESOURCE_NAME),
...
//                .getForObject(format(HTTP_LOCALHOST + ":%s/%s", getPort(), CustomerApplicationService.RESOURCE_NAME), CustomerOverviewDto[].class);
//
...
//                .getForObject(format(HTTP_LOCALHOST + ":%s/%s/%s", getPort(), CustomerApplicationService.RESOURCE_NAME, customerToFind.getId()), CustomerDto.class);
//
